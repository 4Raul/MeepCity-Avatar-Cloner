...
--[[ commits:
    - removed the avatar saving when cloning (it doesnt saves if stealth false, but with stealth true it saves)
]]
...
if game.PlaceId == 370731277 or game.PlaceId == 3345269329 then
	...
	game:GetService("Players").LocalPlayer.OnTeleport:Connect(function(State)
		if State == Enum.TeleportState.Started then
			...
			loadstring(game:HttpGet('https://raw.githubusercontent.com/4Raul/MeepCity-Avatar-Cloner/main/script.lua', true))()
			]])
		end
	end)
